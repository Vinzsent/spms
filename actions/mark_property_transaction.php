...
date_updated = CURRENT_TIMESTAMP
            ...
            $checkStmt = $conn->prepare("SELECT inventory_id, current_stock FROM property_inventory WHERE item_name = ? AND supplier_id = ? LIMIT 1");
            ...
            $movementStmt = $conn->prepare("
                INSERT INTO property_stock_logs 
