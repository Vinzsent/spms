...
<nav class="navbar navbar-expand-lg navbar-dark bg-success px-3">
  ...
  <div class="ms-auto d-flex align-items-center">
    <div class="d-flex align-items-center me-3 position-relative">
      <img src="./assets/images/user.png" alt="Profile" class="avatar rounded-circle me-2" style="width: 40px; height: 40px; object-fit: cover;">
    ...
    <button onclick="toggleDarkMode()" class="btn btn-outline-light me-2">🌙</button>
