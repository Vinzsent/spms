  ...
  <div class="form-section mb-4">
    ...
    <div class="row g-3">
      <div class="col-md-6">
        ...
        <input class="form-control" name="title" id="edit-title" placeholder="Mr., Mrs., Dr., etc.">
      </div>
      <div class="col-md-6">
        <label for="edit-suffix" class="form-label">
    ...
    <div class="row g-3 mt-2">
      <div class="col-md-4">
        ...
        <input class="form-control" name="first_name" id="edit-firstname" placeholder="First Name" required>
      </div>
      <div class="col-md-4">
        <label for="edit-middlename" class="form-label">
          <i class="fas fa-user me-1"></i>Middle Name
        </label>
        <input class="form-control" name="middle_name" id="edit-middlename" placeholder="Middle Name">
      </div>
      <div class="col-md-4">
    ...
    <div class="row g-3 mt-2">
      <div class="col-md-6">
        ...
        <input class="form-control" name="academic_title" id="edit-academictitle" placeholder="Ph.D., M.D., etc.">
      </div>
      <div class="col-md-6">
        <label for="edit-usertype" class="form-label">
  ...
  <div class="form-section mb-4">
    ...
    <div class="row g-3 mt-2">
      <div class="col-md-12">
        ...
        <input class="form-control" type="password" name="password" id="edit-password" placeholder="Leave blank to keep current password">
        <div class="form-text">
