...
$inventory_query = "SELECT * FROM property_inventory";
...
<style>
    ...
    .modal-backdrop.show {
        ...
        /* adjust 0.45–0.6 to taste */
        opacity: 1 !important;
        /* prevent Bootstrap's extra opacity stacking */
    }
</style>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '[data-bs-target="#viewRequestModal"]', function() {
            ...
            console.debug('[Issuance] role check', {
                userType: CURRENT_USER_TYPE,
                normalized: NORMALIZED_USER_ROLE,
                isRoleAllowed
            });
            console.debug('[Issuance] status gates (noted requirement)', {
                hasNotedName,
                hasNotedDate,
                issued: data.issued
            });
            ...
            console.debug('[Issuance] gating summary', {
                currentStatus,
                isAlreadyIssued
            });
        ...
        $(document).on('click', '.issued-redirect-btn', function() {
            ...
            $.get('../actions/search_inventory_by_name.php', {
                    q: itemName
                })
                .done(function(resp) {
        ...
        function openStockMovementModal(item, requestedQty, requestId, requesterName, position, categoryFromRequest) {
            ...
            const sm = new bootstrap.Modal(smEl, {
                backdrop: 'static',
                keyboard: false
            });
            sm.show();
