...
if ($countResult) {
    while ($row = $countResult->fetch_assoc()) {
        $employeeCounts[$row['department']] = $row['total'];
    }
}
?>
...
<div class="wrap">
    <div class="container-fluid px-4" style="margin-top: 60px;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 style="font-size: 22px; color: #1a5f3c; font-weight: 700;"><i class="fas fa-building me-2"></i>Office List Dashboard</h3>
            <div>
            ...
            <div class="card-body p-4">
                <div class="row align-items-center mb-4">
                    <div class="col-md-6 mb-3 mb-md-0">
                        <p class="mb-0 text-muted" style="font-size: 14px; font-weight: 500;">Click the offices to view employee's list.</p>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row g-4" id="officesGrid">
                    ...
                    ?>
                        <div class="col-xl-3 col-lg-4 col-md-6 office-item">
                            <a href="employee_inventory_list.php?office=<?= $urlEncodedOffice ?>" class="text-decoration-none">
                                <div class="card office-card border-0 shadow-sm">
                                    <div class="card-body py-4">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <?php
                                            $count = $employeeCounts[$office] ?? 0;
                                            ?>
                                            <div class="mt-1 text-muted small">
                                                <i class="fas fa-users me-1"></i> <?= $count ?> Employee<?= $count != 1 ? 's' : '' ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
